...
from transformers import LlamaForCausalLM, LlamaTokenizer, BatchEncoding , AutoTokenizer, AutoModelForCausalLM
# from utils.tools import load_quant
...
class LLaMA(BaseLM):
    def __init__(self, model_name, batch_size=1, device="cuda") -> None:
        ...
        self.model = AutoModelForCausalLM.from_pretrained(
            ...
            cache_dir="/public/lzy/llm_weights",
