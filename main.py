...
from utils.prune import wandb, compress_model, prune_magnitude, prune_wanda_ria_bawa, prune_sparsegpt, prune_pruner_zero, prune_pqp, prune_bawa
...
def main(args):
    ...
    # print(model.model)
    # Qmodel = get_model(args.model, args.batch_size)
    ...
    if args.sparsity:
        ...
        elif args.prune_method == "wanda" or args.prune_method == "ria" or args.prune_method == "bawa":
            prune_wanda_ria_bawa(args, model, dataloader, device, prune_n=prune_n, prune_m=prune_m)
        ...
        elif args.prune_method == "jsq":
            joint_pq(args, model, dataloader, device, prune_n=prune_n, prune_m=prune_m)
